...
def correct_datetime_format(date_str):
    if len(date_str) > 11:
        return date_str
...
=======
                print(len(str(deathtime)), len(str(intime)))
>>>>>>> e436071aa2 (prepare mimic 4 data and test StageNet with it)
                if pd.isnull(deathtime):
                    lived_time = 1e18
                else:
                    #print(type(deathtime))
                    #print(type(intime))
                    try:
...
<<<<<<< HEAD
                        ...
                        deathtime = correct_datetime_format(deathtime)
                        intime = correct_datetime_format(intime)
